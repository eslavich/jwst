...
class ReferenceFileModel(DataModel):
    ...
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/referencefile.schema"
...
class ReferenceImageModel(ReferenceFileModel):
    ...
    err : numpy float32 array
         Error array
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/referenceimage.schema"
...
class ReferenceCubeModel(ReferenceFileModel):
    ...
    err : numpy float32 array
         Error array
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/referencecube.schema"
...
class ReferenceQuadModel(ReferenceFileModel):
    ...
    err : numpy float32 array
         Error array
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/referencequad.schema"
