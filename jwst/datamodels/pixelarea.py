...
class PixelAreaModel(ReferenceFileModel):
    ...
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/pixelarea.schema"
...
class NirspecSlitAreaModel(ReferenceFileModel):
    ...
    area_table : numpy table
         ...
         - pixarea: float32
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/nirspec_area_slit.schema"
...
class NirspecMosAreaModel(ReferenceFileModel):
    ...
    area_table : numpy table
         ...
         - pixarea: float32
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/nirspec_area_mos.schema"
...
class NirspecIfuAreaModel(ReferenceFileModel):
    ...
    area_table : numpy table
         ...
         - pixarea: float32
    """
    schema_uri = "http://stsci.edu/schemas/jwst_datamodel/nirspec_area_ifu.schema"
